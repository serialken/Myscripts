#!/bin/bash
# URL de la version staging
STAGING_URL=http://mroadprep.resdom.amaury.local/app_preprod.php/authentification

#Utilisateur distant
REMOTE_USER=mroad

# Serveur de déploiement
REMOTE_SERVER="10.150.10.11"

# Dossier distant de déploiement
REMOTE_FOLDER='/var/www/html/MRoad_Preprod'

# Script POST COPIE
REMOTE_POST_COPY_SCRIPT='deploy'

# Configuration de l'envoi d'email
LOG_MAIL_ENABLED=1
#LOG_MAIL_ADDRESS=AMS-IT-MROAD@amaury.com
LOG_MAIL_ADDRESS=marcantoine.adelise@amaury.com
LOG_MAIL_SUBJECT="[MRoad] Passage en Pré-Production"
LOG_MAIL_BODY=""

# Répertoire racine de la dernière version de l'application
ABS_APP_ROOT_FOLDER=/home/dev-mroad/mroad-app/releases/current/


rsync -Lavz $ABS_APP_ROOT_FOLDER $REMOTE_USER@$REMOTE_SERVER:$REMOTE_FOLDER
ssh -t $REMOTE_USER@$REMOTE_SERVER "$REMOTE_POST_COPY_SCRIPT"
